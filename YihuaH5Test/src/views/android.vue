<template>
  ...
  <div class="container">
    ...
    <van-button type="info" @click="getUserInfo()">getUserInfo</van-button>
    ...
    <van-button type="info" @click="saveMarker()">saveMarker</van-button>
    ...
    <van-button type="info" @click="restart()">restart</van-button>
    <van-button type="primary" @click="logOut()">logOut</van-button>
      ...
      saveMarker() {
        ...
        if (myUser.isAndroid) {
          ...
          connectWebViewJavascriptBridge(function (bridge) {
            ...
            //接收安卓发来的消息   并返回给安卓通知
            bridge.registerHandler("saveMarker", function (str, responseCallback) {
      ...
      getUserInfo() {
        ...
        if (myUser.isAndroid) {
          ...
          connectWebViewJavascriptBridge(function (bridge) {
            ...
            //接收安卓发来的消息   并返回给安卓通知
            bridge.registerHandler("getUserInfo", function (str, responseCallback) {
              var responseData = "我接受到了安卓的调用";
              responseCallback(responseData);
            });
          })
      ...
      restart() {
        ...
        if (myUser.isAndroid) {
          ...
          connectWebViewJavascriptBridge(function (bridge) {
            ...
            //接收安卓发来的消息   并返回给安卓通知
            bridge.registerHandler("restart", function (str, responseCallback) {
              var responseData = "我接受到了安卓的调用";
              responseCallback(responseData);
            });
          })
